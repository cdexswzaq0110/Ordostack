...
| Schedule persistence | Latest generated schedule and recent schedule history |
...
- Schedule diff and named versions.
...
- Schedule manual editing, schedule diff, named versions, and version deletion.
